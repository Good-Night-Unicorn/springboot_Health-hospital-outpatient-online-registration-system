    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">健康医院门诊在线挂号系统注册</h1>
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="医生工号" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengUuidNumber" autocomplete="off" placeholder="医生工号"  />
                           </el-form-item>
                        -->
                        ...
                        <!--
                            <el-form-item label="挂号须知" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengYishengYuyue" autocomplete="off" placeholder="挂号须知"  />
                           </el-form-item>
                        -->
                        ...
                        -->
                        <!--
                            <el-form-item label="履历介绍" class="input" v-if="tableName=='yisheng'">
                                <el-input type="textarea" v-model="ruleForm.yishengContent" placeholder="履历介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yisheng 中的 挂号须知 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengYishengYuyue== null ||this.ruleForm.yishengYishengYuyue== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/jkyymenzhanzaixiangh/img/back-img-bg.jpg);
