            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="赞" prop="zanNumber">
                        <el-input v-model="yaopinForm.zanNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="踩" prop="caiNumber">
                        <el-input v-model="yaopinForm.caiNumber"
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="药品原价" prop="yaopinOldMoney">
                        <el-input v-model="yaopinForm.yaopinOldMoney"
                                  placeholder="药品原价" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="药品热度" prop="yaopinClicknum">
                        <el-input v-model="yaopinForm.yaopinClicknum"
                                  placeholder="药品热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="药品热度" prop="yaopinClicknum">
                            <el-input v-model="ruleForm.yaopinClicknum"
                                      placeholder="药品热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
