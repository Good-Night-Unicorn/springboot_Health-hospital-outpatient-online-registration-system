    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="yaopinCollectionTypes">
                        <el-select v-model="ruleForm.yaopinCollectionTypes" :disabled="ro.yaopinCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in yaopinCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="yaopinCollectionValue">
                        <el-input v-model="ruleForm.yaopinCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yaopinId: false,
                    yonghuId: false,
                    yaopinCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    yaopinId: '',
                    yonghuId: '',
                    yaopinCollectionTypes: '',
                    insertTime: '',
                },
                yaopinCollectionTypesOptions : [],
                yaopinOptions : [],
                yonghuOptions : [],
                rules: {
                   yaopinId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yaopin_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yaopinCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yaopinCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yaopinCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
