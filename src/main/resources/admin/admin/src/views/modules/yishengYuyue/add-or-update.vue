    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yisheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="挂号须知" prop="yishengYishengYuyue">
                        <el-input v-model="yishengForm.yishengYishengYuyue"
                                  placeholder="挂号须知" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="挂号须知" prop="yishengYishengYuyue">
                            <el-input v-model="ruleForm.yishengYishengYuyue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.yishengYuyueTime"  class="input" label="挂号时间" prop="yishengYuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueTime" label="挂号时间" prop="yishengYuyueTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="yishengYuyueText">
                        <el-input type="textarea"  :readonly="ro.yishengYuyueText" v-model="ruleForm.yishengYuyueText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueText" label="备注" prop="yishengYuyueText">
                            <span v-html="ruleForm.yishengYuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="挂号状态" prop="yishengYuyueTypes">
                        <el-select v-model="ruleForm.yishengYuyueTypes" :disabled="ro.yishengYuyueTypes" placeholder="请选择挂号状态">
                            <el-option
                                v-for="(item,index) in yishengYuyueTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="挂号状态" prop="yishengYuyueValue">
                        <el-input v-model="ruleForm.yishengYuyueValue"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yisheng_yuyue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yishengYuyueTypesOptions = data.data.list;
                    }
                });
