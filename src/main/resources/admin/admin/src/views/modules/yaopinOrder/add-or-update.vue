    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单编号" prop="yaopinOrderUuidNumber">
                       <el-input v-model="ruleForm.yaopinOrderUuidNumber"
                                 placeholder="订单编号" clearable  :readonly="ro.yaopinOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="订单编号" prop="yaopinOrderUuidNumber">
                           <el-input v-model="ruleForm.yaopinOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="yaopinOrderTruePrice">
                       <el-input v-model="ruleForm.yaopinOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.yaopinOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="实付价格" prop="yaopinOrderTruePrice">
                           <el-input v-model="ruleForm.yaopinOrderTruePrice"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="yaopinOrderCourierName">
                       <el-input v-model="ruleForm.yaopinOrderCourierName"
                                 placeholder="快递公司" clearable  :readonly="ro.yaopinOrderCourierName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递公司" prop="yaopinOrderCourierName">
                           <el-input v-model="ruleForm.yaopinOrderCourierName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="快递单号" prop="yaopinOrderCourierNumber">
                       <el-input v-model="ruleForm.yaopinOrderCourierNumber"
                                 placeholder="快递单号" clearable  :readonly="ro.yaopinOrderCourierNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="快递单号" prop="yaopinOrderCourierNumber">
                           <el-input v-model="ruleForm.yaopinOrderCourierNumber"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="yaopinOrderTypes">
                        <el-select v-model="ruleForm.yaopinOrderTypes" :disabled="ro.yaopinOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in yaopinOrderTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="yaopinOrderValue">
                        <el-input v-model="ruleForm.yaopinOrderValue"
                            placeholder="订单类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="yaopinOrderPaymentTypes">
                        <el-select v-model="ruleForm.yaopinOrderPaymentTypes" :disabled="ro.yaopinOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in yaopinOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="支付类型" prop="yaopinOrderPaymentValue">
                        <el-input v-model="ruleForm.yaopinOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yaopinOrderUuidNumber: false,
                    addressId: false,
                    yaopinId: false,
                    yonghuId: false,
                    buyNumber: false,
                    yaopinOrderTruePrice: false,
                    yaopinOrderCourierName: false,
                    yaopinOrderCourierNumber: false,
                    yaopinOrderTypes: false,
                    yaopinOrderPaymentTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    yaopinOrderUuidNumber: new Date().getTime(),
                    addressId: '',
                    yaopinId: '',
                    yonghuId: '',
                    buyNumber: '',
                    yaopinOrderTruePrice: '',
                    yaopinOrderCourierName: '',
                    yaopinOrderCourierNumber: '',
                    yaopinOrderTypes: '',
                    yaopinOrderPaymentTypes: '',
                    insertTime: '',
                },
                yaopinOrderTypesOptions : [],
                yaopinOrderPaymentTypesOptions : [],
                addressOptions : [],
                yaopinOptions : [],
                yonghuOptions : [],
                rules: {
                   yaopinOrderUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yaopin_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yaopinOrderTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yaopin_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yaopinOrderPaymentTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yaopinOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yaopinOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
