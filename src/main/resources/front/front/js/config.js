...
var centerMenu = [
    ...
    ,{
        name: '药品收藏',
        url: '../yaopinCollection/list.html'
    }
    ,{
        name: '药品评价',
        url: '../yaopinCommentback/list.html'
    }
    ,{
        name: '药品订单',
        url: '../yaopinOrder/list.html'
    }
    ,{
        name: '医生收藏',
        url: '../yishengCollection/list.html'
    }
    ,{
        name: '医生评价',
        url: '../yishengCommentback/list.html'
    }
    ,{
        name: '挂号',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/jkyymenzhanzaixiangh/admin/dist/index.html#/login";
